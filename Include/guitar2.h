// title:        "guitar2.h" ver6.5.1beta 
// description:  diagramMML変換付きguitar支援スクリプト (22/ 1/ 8)
...
　#Arp_set= "r323 1232" // "arp"の演奏デフォルト
...
Function String_Assgin(Str TT,""){ // 弦特性 
	...
	Case("T9"){ //arp
		...
		Switch(#Device_set){
		Case("XG"){	RR= (-23,-17,-11,  -5, -2, -1); } // 演奏モデル
		...
		Switch(#Device_set){
		Case("XG"){	RR= (0, -4,-12, -20,-28,-36); } // 構造モデル
